...
posts = Post.create!(
  [
    ...
    {
      title: '岐阜メディアコスモス',
      content: '伊東豊雄さんが設計した図書館のある複合施設にお邪魔してきました。薄い曲面板からなる建築構造のシェル構造をヒントに岐阜産のヒノキを三方向に丸く組み上げ、全体的に包み込まれるような大きな曲線で構成された天井のもとに、採光、空調としての機能性、デザイン性を兼ねそろえたグローブが絶妙に配置されていました。',
      image: File.open('./public/images/sample.jpg'),
      user_id: users[1].id
    },
    {
